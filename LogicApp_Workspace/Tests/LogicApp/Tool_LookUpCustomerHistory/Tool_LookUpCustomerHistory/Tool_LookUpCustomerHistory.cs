...
using LogicApp.Tests.Mocks.Tool_LookUpCustomerHistory;
...
namespace LogicApp.Tests
{
    ...
    /// </summary>
    [TestClass]
    public class Tool_LookUpCustomerHistory
    {
        /// <summary>
        ...
        public void Setup()
        {
            this.TestExecutor = new TestExecutor("Tool_LookUpCustomerHistory/testSettings.config");
        }

        /// <summary>
        /// A sample unit test for executing the workflow named Tool_LookUpCustomerHistory with static mocked data.
        /// This method shows how to set up mock data, execute the workflow, and assert the outcome.
        /// </summary>
        [TestMethod]
        public async Task Tool_LookUpCustomerHistory_Tool_LookUpCustomerHistory_ExecuteWorkflow_SUCCESS_Sample1()
        {
            // PREPARE Mock
            ...
            var actionMockOutput = new GetSampleTestDataActionOutput();
            ...
            var actionMock = new GetSampleTestDataActionMock(name: "Get_Sample_Test_Data", outputs: actionMockOutput);
        ...
        /// <summary>
        /// A sample unit test for executing the workflow named Tool_LookUpCustomerHistory with dynamic mocked data.
        /// This method shows how to set up mock data, execute the workflow, and assert the outcome.
        /// </summary>
        [TestMethod]
        public async Task Tool_LookUpCustomerHistory_Tool_LookUpCustomerHistory_ExecuteWorkflow_SUCCESS_Sample2()
        {
            // PREPARE
            // Generate mock trigger data.
            var triggerMockOutput = new WhenAHTTPRequestIsReceivedTriggerOutput();
            ...
            var actionMock = new GetSampleTestDataActionMock(name: "Get_Sample_Test_Data", onGetActionMock: GetSampleTestDataActionMockOutputCallback);
            // OPTION 2: defining inline using a lambda
            /*var actionMock = new GetSampleTestDataActionMock(name: "Get_Sample_Test_Data", onGetActionMock: (testExecutionContext) =>
            {
                return new GetSampleTestDataActionMock(
                    status: TestWorkflowStatus.Succeeded,
                    outputs: new GetSampleTestDataActionOutput {
        ...
        public GetSampleTestDataActionMock GetSampleTestDataActionMockOutputCallback(TestExecutionContext context)
        {
